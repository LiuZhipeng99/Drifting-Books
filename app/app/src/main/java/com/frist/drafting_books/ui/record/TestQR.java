...
public class TestQR extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_qr_layout);
        ...
        switch (v.getId()) {
            case R.id.button_zxing:
                ...
                if (TextUtils.isEmpty(count)) {
                    Toast.makeText(TestQR.this, "请输入内容", Toast.LENGTH_LONG).show();
                    return;
                }
                //生成二维码显示在imageView上
